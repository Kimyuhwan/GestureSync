...
.controller('trainCtrl', function($scope, $interval, $cordovaDeviceMotion, $localstorage, $analyzer, $cordovaMedia, $state, $cordovaNativeAudio) {
                 ...
                 if($scope.analysis_index % 2 == 0) {
                     ...
                     if($scope.current_state !== 'Left') {
                        ...
                        if(left_distance < 15) {
                            ...
                            // 소리 Play
                            $cordovaNativeAudio.play('effect', function(msg) {console.log(msg)});
                        }
